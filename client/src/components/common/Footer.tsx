...
const Footer = () => {
  return (
    <footer className="border-t-2 border-gray-500text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
      ...
      {/* <!--Copyright section--> */}
      <div className="bg-neutral-500 p-6 text-center text-neutral-300 dark:bg-neutral-700">
